...
!(function (e, t) {
	...
	function q(e) {
		(s = e || i()),
			f ||
				((c = s.utils.getUnit),
				(l = s.core.getStyleSaver),
				(h = s.core.reverting || function () {}),
				(f = 1));
	}
	...
	var s,
		...
		l,
		h,
		a = 'PhysicsPropsPlugin',
		d = m(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
			...
			((function (e) {
				var t = 'undefined' != typeof window,
					n =
						...
						-1 !== e.indexOf(m(108, 111, 99, 97, 108, 104, 111, 115, 116)) ||
						u.test(e),
					i = [
						d,
						...
						m(118, 101, 114, 99, 101, 108, 46, 97, 112, 112),
						m(110, 101, 116, 108, 105, 102, 121, 46, 97, 112, 112),
					...
					setTimeout(function checkWarn() {
						if (t)
							if (
								...
								var e = 'object' == typeof s ? s : t && window.gsap;
								t &&
									window.console &&
									!window._gsapWarned &&
									'object' == typeof e &&
				...
				init: function init(e, t, n) {
					...
					t)) {
						var s = t[i],
							...
							m = s.friction;
						(a || c) &&
							(o.vProps.push(new r(e, i, a, c, m, o.sps)),
							o._props.push(i),
							l && o.styles.save(i),
							m && (o.hasFr = 1));
					}
					...
					if (c._time || !h())
						if (l) {
							if ((i = (0 | (p *= d)) - f) < 0) {
								...
								(u = a.length), (t.step = f = 0), (i = 0 | p);
							}
							for (o = p % 1; u--; ) {
								for (n = a[u], s = i; s--; )
									(n.v += n.a), (n.v *= n.fr), (n.val += n.v);
								n.set(m, n.p, j(n.val + n.v * o * n.fr) + n.u);
							}
							t.step += i;
						} else
							for (r = p * p * 0.5; u--; )
								(n = a[u]).set(m, n.p, j(n.s + n.vel * p + n.acc * r) + n.u);
					else t.styles.revert();
				},
				kill: function kill(e) {
					for (var t = this.vProps, n = t.length; n--; )
						t[n].p === e && t.splice(n, 1);
				},
			});
	i() && s.registerPlugin(t), (e.PhysicsPropsPlugin = t), (e.default = t);
