...
!(function (t, e) {
	...
	function transformRawPath(t, e, n, i, s, a, o) {
		for (var r, h, l, c, d, u = t.length; -1 < --u; )
			for (h = (r = t[u]).length, l = 0; l < h; l += 2)
				(c = r[l]),
					(d = r[l + 1]),
					(r[l] = c * e + d * i + a),
					(r[l + 1] = c * n + d * s + o);
		...
		if (t !== r || e !== h) {
			...
			for (B = 0; B < O; B++)
				(_ = F((s = R + B * I))),
					...
					(M = F((s += I))),
					(D = W(s)),
					X.push(_ - G * m, m + G * _, M + G * D, D - G * M, M, D);
			for (B = 0; B < X.length; B += 2)
				(_ = X[B]),
					(m = X[B + 1]),
					(X[B] = _ * q + m * V + E),
					(X[B + 1] = _ * z + m * j + k);
			return (X[B - 2] = r), (X[B - 1] = h), X;
		}
	}
	function stringToRawPath(t) {
		...
		for (e = 0; e < y; e++)
			if (
				((g = a),
				isNaN(_[e]) ? (o = (a = _[e].toUpperCase()) !== _[e]) : e--,
				(i = +_[e + 1]),
				(s = +_[e + 2]),
				o && ((i += v), (s += b)),
				e || ((h = i), (l = s)),
				...
				r && (r.length < 8 ? --m.length : (P += r.length)),
					(v = h = i),
					(b = l = s),
					(r = [i, s]),
					m.push(r),
				...
				(c = v),
					(d = b),
					('C' !== g && 'S' !== g) ||
						((c += v - r[r.length - 4]), (d += b - r[r.length - 3])),
					o || (v = b = 0),
					r.push(c, d, i, s, (v += 1 * _[e + 3]), (b += 1 * _[e + 4])),
					(e += 4);
			else if ('Q' === a)
				(c = v + (2 / 3) * (i - v)),
					(d = b + (2 / 3) * (s - b)),
					...
					(v += 1 * _[e + 3]),
					(b += 1 * _[e + 4]),
					r.push(c, d, v + (2 / 3) * (i - v), b + (2 / 3) * (s - b), v, b),
					(e += 4);
			else if ('T' === a)
				(c = v - r[r.length - 4]),
					(d = b - r[r.length - 3]),
					...
					(e += 2);
			else if ('H' === a) yd(v, b, (v = i), b), (e += 1);
			else if ('V' === a) yd(v, b, v, (b = i + (o ? b - v : 0))), (e += 1);
			else if ('L' === a || 'Z' === a)
				'Z' === a && ((i = h), (s = l), (r.closed = !0)),
					('L' === a || 0.5 < Q(v - i) || 0.5 < Q(b - s)) &&
						(yd(v, b, i, s), 'L' === a && (e += 2)),
					(v = i),
					(b = s);
			else if ('A' === a) {
		...
		return (
			(e = r.length) < 6
				? (m.pop(), (e = 0))
				: r[0] === r[e - 2] && r[1] === r[e - 1] && (r.closed = !0),
			(m.totalPoints = P + e),
			m
		);
	}
	function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
		...
		return (
			...
			h * (C * C + S * S) < (x + E) * (x + E) &&
				((d = l.length),
				bezierToPoints(t, e, u, g, v, b, A, w, h, l, c),
				bezierToPoints(A, w, y, P, _, m, o, r, h, l, c + 2 + (l.length - d))),
			l
		);
	}
	function pointsToSegment(t, e) {
		...
		var i,
			...
			w = y - v,
			C = P - b,
			S = Math.abs(t[m] - v) < 0.001 && Math.abs(t[m + 1] - b) < 0.001;
		for (
			S &&
				(t.push(y, P),
				(y = v),
			...
			(i = v),
				...
				(v === y && b === P) ||
					...
					(C = P - b),
					(c =
						(((h = U(o * o + r * r)) + (l = U(w * w + C * C))) * e * 0.25) /
						U(Math.pow(w / l + o / h, 2) + Math.pow(C / l + r / h, 2))),
					(g =
						v -
						((d = v - (v - i) * (h ? c / h : 0)) +
							((((u = v + (y - v) * (l ? c / l : 0)) - d) *
					...
					(_ =
						...
						((p = b - (b - s) * (h ? c / h : 0)) +
							((((f = b + (P - b) * (l ? c / l : 0)) - p) *
								...
								4 || 0))),
					(v === i && b === s) ||
						A.push(n(d + g), n(p + _), n(v), n(b), n(u + g), n(f + _)));
		return (
			v !== y || b !== P || A.length < 4
				? A.push(n(y), n(P), n(y), n(P))
				: (A.length -= 2),
			2 === A.length
				? A.push(v, b, v, b, v, b)
				: S && (A.splice(0, 6), (A.length = A.length - 6)),
			A
		);
	}
	function simplifyPoints(t, e) {
		var n,
			...
			d = [l, c],
			u = t.length - 2;
		for (e = Math.pow(e || 1, 2), n = 2; n < u; n += 2)
			e <
				(a = l - (i = parseFloat(t[n]))) * a +
					(o = c - (s = parseFloat(t[n + 1]))) * o &&
				(d.push(i, s), (l = i), (c = s));
		return (
			...
			(function simplifyStep(t, e, n, i, s) {
				...
				for (o = e + 2; o < n; o += 2)
					(h = t[o]),
						...
						(_ = (g = P) - (d = b)),
						((f = (u = y) - (c = v)) || _) &&
							(1 < (p = ((h - c) * f + (l - d) * _) / (f * f + _ * _))
								? ((c = u), (d = g))
								: 0 < p && ((c += f * p), (d += _ * p))),
						m < (r = Math.pow(h - c, 2) + Math.pow(l - d, 2)) &&
							((a = o), (m = r));
				i < m &&
					(2 < a - e && simplifyStep(t, e, a, i, s),
					s.push(t[a], t[a + 1]),
					2 < n - a && simplifyStep(t, a, n, i, s));
	...
	function J(t, e) {
		if (t.parentNode && (g || B(t))) {
			var n = H(t),
				...
				h = g.createElementNS
					? g.createElementNS(i.replace(/^https/, 'http'), s)
					: g.createElement(s);
			return (
				e &&
					(n
						? ((m = m || J(t)),
						  ...
						  h.setAttribute('transform', 'translate(' + a + ',' + o + ')'),
						  m.appendChild(h))
						: (u || ((u = J(t)).style.cssText = r),
						  (h.style.cssText =
								r +
	...
	function M(t, e) {
		...
		if ((c.length || c.push(J(t, 1), J(t, 2), J(t, 3)), (n = h ? m : u), h))
			...
			if (((a = o = 0), y))
				for (
					i = t.offsetParent, s = t;
					(s = s && s.parentNode) && s !== i && s.parentNode;

				)
					4 < (p.getComputedStyle(s)[S] + '').length &&
						((a = s.offsetLeft), (o = s.offsetTop), (s = 0));
			if (
				'absolute' !== (r = p.getComputedStyle(t)).position &&
				'fixed' !== r.position
			)
				for (i = t.offsetParent; d && d !== i; )
					(a += d.scrollLeft || 0), (o += d.scrollTop || 0), (d = d.parentNode);
			((s = n.style).top = t.offsetTop - o + 'px'),
				(s.left = t.offsetLeft - a + 'px'),
				(s[S] = r[S]),
				(s[x] = r[x]),
				(s.position = 'fixed' === r.position ? 'fixed' : 'absolute'),
		...
		D =
			...
			(e.apply = function apply(t, e) {
				...
				var n = t.x,
					...
					l = this.f;
				return (
					(e.x = n * s + i * o + h || 0), (e.y = n * a + i * r + l || 0), e
				);
			}),
			Matrix2D);
	...
	function getGlobalMatrix(t, e, n, i) {
		if (!t || !t.parentNode || (g || B(t)).documentElement === t)
			return new D();
		var s = (function _forceNonZeroScale(t) {
			...
			d =
				...
				(function _isFixed(t) {
					return (
						'fixed' === p.getComputedStyle(t).position ||
		...
		if ((c.removeChild(o), s))
			for (r = s.length; r--; )
				((h = s[r]).scaleX = h.scaleY = 0), h.renderTransform(1, h);
	...
	function oa(t) {
		return T.createElementNS
			? T.createElementNS('http://www.w3.org/1999/xhtml', t)
			: T.createElement(t);
	}
	function pa(t, e, n) {
		var i,
		...
		for (i in (((n = n || {}).class = n.class || 'path-editor'), n))
			void 0 !== s.style[i]
				? (s.style[i] = n[i])
				: s.setAttributeNS(null, i.replace(a, '$1-$2').toLowerCase(), n[i]);
	...
	function xa(t) {
		if (!t.target._gsSelection && !$ && 100 < j() - Z) {
	...
	function Ba(t, e, n, i) {
		if (t.addEventListener) {
			var s = X[e];
			(i = i || {passive: !1}),
				t.addEventListener(s || e, n, i),
				s &&
					e !== s &&
					'pointer' !== s.substr(0, 7) &&
	...
	function Ea(t) {
		(ot = t.touches && _dragCount < t.touches.length),
			Ca(t.target, 'touchend', Ea);
	}
	function Fa(t) {
		(ot = t.touches && _dragCount < t.touches.length),
			Ba(t.target, 'touchend', Ea);
	}
	function Ga(e, n) {
		return function (t) {
			return e.call(n, t);
			...
			T.addEventListener(
				...
				function (t) {
					...
					if ('Shift' === o || 16 === a) L = !0;
						...
						for (R = !0, e = st.length; -1 < --e; ) st[e]._onPressAlt();
					else if (('z' === o || 90 === a) && (l || d) && 1 < tt.length) {
						if ((tt.shift(), (n = tt[0]))) {
							for (
								(s = n.path).path.setAttribute('d', n.d),
									s.path.setAttribute('transform', n.transform),
									s.init(),
									i = s._anchors,
									e = 0;
								e < i.length;
								...
								-1 !== n.selectedIndexes.indexOf(i[e].i) &&
									s._selectedAnchors.push(i[e]);
							s._updateAnchors(),
								s.update(),
								s.vars.onUndo && s.vars.onUndo.call(s);
						}
					} else if (
						'Delete' === o ||
						'Backspace' === o ||
						...
						for (e = st.length; -1 < --e; ) st[e]._deleteSelectedAnchors();
					else if (('a' === o || 65 === a) && (d || l))
						for (e = st.length; -1 < --e; ) st[e].select(!0);
				},
				!0
			),
			T.addEventListener(
	...
	function Ma(t) {
		...
		(this._matrix = this.target.transform.baseVal.getItem(0).matrix),
			...
			X[t.type]
				? ((e =
						-1 !== t.type.indexOf('touch') ? t.currentTarget || t.target : T),
	...
	function Oa(t, e) {
		...
		if (
			...
			if (
				(r
					? (Ca(r, 'touchend', n._onRelease),
					  Ca(r, 'touchmove', n._onMove),
					  Ca(r, 'touchcancel', n._onRelease),
					  Ca(T, 'touchstart', Fa))
					: Ca(T, 'mousemove', n._onMove),
				h ||
					(Ca(T, 'mouseup', n._onRelease),
					t && t.target && Ca(t.target, 'mouseup', n._onRelease)),
				o
					? (n.isDragging = !1)
					: n.vars.onClick && n.vars.onClick.call(n.vars.callbackScope || n, a),
				t)
			) {
				if (
					(i = t.changedTouches) &&
	...
	var T,
		...
		ot = 0,
		rt =
			(((q = DraggableSVG.prototype).setPointerPosition =
				function setPointerPosition(t, e) {
					var n, i, s, a, o;
					(this.pointerX = t),
						(this.pointerY = e),
						this._ctm &&
						...
						this.snap &&
							...
							((et.x = s),
							(et.y = a),
							this.snap.call(this, et),
							(s = et.x),
							(a = et.y)),
						(this.x === s && this.y === a) ||
							((this._matrix.f = this.y = a),
							(this._matrix.e = this.x = s),
							!this.isDragging &&
								this.isPressed &&
								((this.isDragging = !0),
								Ha('onDragStart', this, this.pointerEvent)));
				}),
			(q.enabled = function enabled(t) {
				return arguments.length
					? ((this._enabled = t)
							? (h || Ba(this.target, 'mousedown', this._onPress),
							  Ba(this.target, 'touchstart', this._onPress),
							  Ba(this.target, 'click', this._onClick, !0))
							: ((e = this.isDragging),
							  ...
							  this.touchEventTarget &&
									(Ca(this.touchEventTarget, 'touchcancel', this._onRelease),
									Ca(this.touchEventTarget, 'touchend', this._onRelease),
									Ca(this.touchEventTarget, 'touchmove', this._onMove)),
			...
			(ht.update = function update(t, e, n) {
				...
				(this.segment = s),
					(this.smooth =
						...
						n < s.length - 2 &&
						Math.abs(
							Math.atan2(s[n + 1] - s[1 + a], s[n] - s[a]) -
								Math.atan2(s[n + 3] - s[n + 1], s[n + 2] - s[n])
						) < 0.09
							? 2
							: 0),
					this.smooth !== i &&
	...
	function Anchor(t, e, n, i, s) {
		(this.editor = t),
			(this.element = pa('path', t._selection, {
				fill: V,
				stroke: V,
				strokeWidth: 2,
			...
			(this.vars = s || {}),
			(this._draggable = new rt(this.element, {
				callbackScope: this,
				onDrag: this.onDrag,
				snap: this.vars.snap,
	...
	var ct,
		dt =
			(((ct = PathEditor.prototype)._onRelease = function _onRelease(t) {
				...
				e && ((K.x = e.segment[e.i]), (K.y = e.segment[e.i + 1])),
					Ca(c, 'touchforcechange', na),
					Ha('onRelease', this, t);
			}),
			(ct.init = function init() {
				...
				if (((this._rawPath = i), a)) {
					if (((this._anchors = Pa(i, 0, this, o)), 1 < (t = i.length)))
						for (e = 1; e < t; e++)
							this._anchors = this._anchors.concat(Pa(i, e, this, o));
				} else
				...
				return (
					...
					this._g.setAttribute(
						...
						(function _getConcatenatedTransforms(t) {
							for (
								var e = ra(t), n = t.ownerSVGElement;
				...
				if ('hidden' === this._selection.style.visibility) this.select();
					...
					for (
						this._draggable && this._draggable._onRelease(t),
							l &&
								((a = t.clientX * l.a + t.clientY * l.c + l.e),
								(o = t.clientX * l.b + t.clientY * l.d + l.f)),
			...
			(ct.select = function select(t) {
				...
				return (
					-1 === st.indexOf(this) && st.push(this), this._updateAnchors(), this
				);
			}),
			...
			(ct._onDragPath = function _onDragPath() {
				...
				this._selection.setAttribute('transform', t),
					this.path.setAttribute('transform', t);
			}),
			(ct._onPressAnchor = function _onPressAnchor(t) {
				-1 === this._selectedAnchors.indexOf(t)
					? (L || (this._selectedAnchors.length = 0),
					...
					? ((t.smooth = !t.smooth),
					  ...
					  !t.smooth || (d && !t.isClosedStart)
							? t.smooth ||
							  ...
							  ((r || t.isClosedStart) &&
									((h[l] = h[r]), (h[1 + l] = h[r + 1])),
							  r < h.length - 2 && ((h[r + 2] = h[r]), (h[r + 3] = h[r + 1])),
							  this._updateAnchors(),
							  this.update(),
							  this._saveState())
							: ((e =
									((e = Math.atan2(h[r + 1] - h[1 + l], h[r] - h[l])) +
										(n = Math.atan2(h[r + 3] - h[r + 1], h[r + 2] - h[r]))) /
									2),
							  (i = Qa(h, l, r)),
							  (s = Qa(h, r, r + 2)),
							  i < 0.2 &&
									((i = Qa(h, r, l - 4) / 4),
									(e =
										n || Math.atan2(h[r + 7] - h[l - 3], h[r + 6] - h[l - 4]))),
							  s < 0.2 &&
									((s = Qa(h, r, r + 6) / 4),
									(n =
										e || Math.atan2(h[r + 7] - h[l - 3], h[r + 6] - h[l - 4]))),
							  (a = Math.sin(e)),
							  (o = Math.cos(e)),
					...
					i && (t || i.isClosedStart)
						? ((e = i.isClosedStart ? s[s.length - 4] : s[t - 2]),
						  ...
						  (this._handle1.style.visibility = this._line1.style.visibility =
								R || e !== s[t] || n !== s[t + 1] ? 'visible' : 'hidden'),
						  this._handle1.setAttribute(
								'transform',
								'translate(' + e + it + n + ')'
						  ),
			...
			(ct.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
				var s,
					...
					f = -t || c[g - 1] + u;
				for (
					f = f ? 1 / f : -p, p *= 1e3, f *= 1e3, a = nt.length = 0;
					a < g;
					a += 2
				)
					(nt[a] = (((c[a] + d) * p) | 0) / 1e3),
						(nt[a + 1] = (((c[a + 1] + u) * f) | 0) / 1e3);
				if (i) {
	...
	function PathEditor(t, e) {
		(e = e || {}),
			...
			(this._g = pa('g', this.path.ownerSVGElement, {
				class: 'path-editor-g path-editor',
			})),
			(this._selectionHittest = pa('path', this._g, {
				stroke: 'transparent',
				strokeWidth: 16,
				fill: 'none',
				vectorEffect: 'non-scaling-stroke',
			...
			(this._selection =
				e._selection ||
				pa('g', this._g, {class: 'path-editor-selection path-editor'})),
			(this._selectionPath = pa('path', this._selection, {
				stroke: V,
				strokeWidth: 2,
				fill: 'none',
				vectorEffect: 'non-scaling-stroke',
			...
			(this._line1 = pa('polyline', this._selection, {
				stroke: V,
				strokeWidth: 2,
				vectorEffect: 'non-scaling-stroke',
			})),
			(this._line2 = pa('polyline', this._selection, {
				stroke: V,
				strokeWidth: 2,
				vectorEffect: 'non-scaling-stroke',
			})),
		...
		(this._squareHandle = (function _getSquarePathData(t) {
			...
			(this._handle1 = pa('path', this._selection, {
				d: this._squareHandle,
				fill: V,
				stroke: 'transparent',
				strokeWidth: 6,
			})),
			(this._handle2 = pa('path', this._selection, {
				d: this._squareHandle,
				fill: V,
				stroke: 'transparent',
				strokeWidth: 6,
			})),
			(this._handle1._draggable = new rt(this._handle1, {
			...
			(this._handle2._draggable = new rt(this._handle2, {
		...
		for (
			...
			s[a]._gsSelection = !0;
		!1 !== e.draggable &&
			(this._draggable = new rt(this._selectionHittest, {
				callbackScope: this,
				onPress: this.select,
				onRelease: this._onRelease,
			...
			h ||
				(Ba(
					this._selectionHittest,
					'mousedown',
					Ga(this._onClickSelectionPath, this)
				),
				Ba(this._selectionHittest, 'mouseup', Ga(this._onRelease, this))),
			Ba(
				this._selectionHittest,
				'touchstart',
				Ga(this._onClickSelectionPath, this)
		...
		(dt.simplifySVG = function (t, e) {
			...
			if (
				...
				('#' !== t.charAt(0) && '.' !== t.charAt(0)) ||
					((n = T.querySelector(t)) && (t = n.getAttribute('d'))),
				(i =
				...
				(i = pointsToSegment(simplifyPoints(i, d), e.curviness))[2] =
					'C' + i[2];
				...
				function (t) {
					...
					(u && a < h) || (i = a - h) * i < r
						...
						p &&
							...
							s * s < r && (o = p.y)),
						f &&
							(i = (e = h + Math.round((a - h) / f) * f) - a) * i +
								(s = (n = l + Math.round((o - l) / f) * f) - o) * s <
								r &&
							((a = e), (o = n)),
						(t.x = a),
						(t.y = o);
	...
	function pb(t, e, n) {
		return ib(t) && St.test(t)
			? pt.querySelector(t)
			: Array.isArray(t)
			? bt(
					vt(
						[{x: ut.getProperty(e, 'x'), y: ut.getProperty(e, 'y')}].concat(t),
						n
					)
			  )
			: ib(t) || (t && 'path' === (t.tagName + '').toLowerCase())
			? t
			: 0;
	}
	function ub(t, e) {
		...
		(gt = window),
			...
			ut &&
				((mt = ut.plugins.motionPath),
				(Et.PathEditor = dt),
				(yt = ut.core.context || function () {})),
			mt
				? ((function _initCopyToClipboard() {
						((Pt = jb('textarea')).style.display = 'none'), _t.appendChild(Pt);
				  })(),
					...
					n =
						0 ===
							(e ? window.location.href : '').indexOf(
								db(102, 105, 108, 101, 58, 47, 47)
							) ||
						-1 !== t.indexOf(db(108, 111, 99, 97, 108, 104, 111, 115, 116)) ||
						Ct.test(t),
					i = [
						wt,
					...
					setTimeout(function checkWarn() {
						if (e)
							if (
								...
								var t = 'object' == typeof ut ? ut : e && window.gsap;
								e &&
									window.console &&
									!window._gsapWarned &&
									'object' == typeof t &&
									...
									(console.log(
										db(37, 99, 87, 97, 114, 110, 105, 110, 103),
										db(
											102,
											111,
											110,
					...
					setTimeout(function () {
						e &&
							(window.location.href =
								db(104, 116, 116, 112, 115, 58, 47, 47) +
								wt +
								db(
									47,
									114,
		...
		t instanceof ut.core.Tween
			...
			(h = (function _getPositionOnPage(t) {
				var e = t.getBoundingClientRect(),
					n =
						ft.clientTop -
						(gt.pageYOffset || ft.scrollTop || _t.scrollTop || 0),
					i =
						ft.clientLeft -
						(gt.pageXOffset || ft.scrollLeft || _t.scrollLeft || 0);
				return {
					left: e.left + i,
					top: e.top + n,
					right: e.right + i,
			...
			c &&
				!s &&
				(s = pb(
					c.vars.motionPath.path || c.vars.motionPath,
					i,
					c.vars.motionPath
				)),
			...
			(l = s && s.ownerSVGElement)
				? (e.pathColor && ut.set(s, {stroke: e.pathColor}),
				  e.pathWidth && ut.set(s, {strokeWidth: e.pathWidth}),
				  e.pathOpacity && ut.set(s, {opacity: e.pathOpacity}))
				: ((d =
						(a &&
							i.ownerSVGElement &&
			...
			e.center &&
				ut.set(i, {transformOrigin: '50% 50%', xPercent: -50, yPercent: -50}),
			c
				? (c.vars.motionPath.path
			...
			(this.kill = this.revert =
				function () {
					n.editor.kill(),
						...
						a || (l.parentNode && l.parentNode.removeChild(l)),
						f && f.revert();
				});
	}
	(Et.register = ub),
		...
		(Et.editPath = function (t, e) {
			return dt.create(t, e);
		}),
		(Et.version = '3.12.0'),
		(t.MotionPathHelper = Et),
		(t.default = Et);
