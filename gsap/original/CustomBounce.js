...
!(function (e, n) {
	...
	function h(e) {
		(r = g()),
			(j = r && r.parseEase('_CE'))
				? ((b = 1),
				  (r.parseEase('bounce').config = function (e) {
	...
	var r,
		...
		j,
		u = 'CustomBounce',
		s = l(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
		...
		B = (function (e) {
			var n = 'undefined' != typeof window,
				t =
					...
					-1 !== e.indexOf(l(108, 111, 99, 97, 108, 104, 111, 115, 116)) ||
					c.test(e),
				o = [
					s,
				...
				setTimeout(function checkWarn() {
					if (n)
						if (
							...
							var e = 'object' == typeof r ? r : n && window.gsap;
							n &&
								window.console &&
								!window._gsapWarned &&
								'object' == typeof e &&
			...
			if ((b || h(1), (n = n || {}), B)) {
				...
				for (
					...
					d &&
						...
						C.push(y - d, 1, y, 1, y, 1),
						(d *= a * a)),
					C.push(y, 1, t, r, l, r, o, r, s, 1, s, 1),
					(a *= 0.95),
					(p = m / (s - o)),
					(y = s),
					!(0.999 < r));
				...
				if (n.endAtStart && 'false' !== n.endAtStart) {
					if (((l = -0.1), C.unshift(l, 1, l, 1, -0.07, 0), g))
						for (
							l -= d = 2.5 * g,
								C.unshift(l, 1, l, 1, l, 1),
								v.splice(0, 6),
								v.unshift(
									l,
									0,
				...
				return (
					d &&
						(i(v),
						(v[2] = 'C' + v[2]),
						j(n.squashID || e + '-squash', 'M' + v.join(','))),
					i(C),
					(C[2] = 'C' + C[2]),
					j(e, 'M' + C.join(','))
				);
