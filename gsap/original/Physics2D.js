...
!(function (n, e) {
	...
	function r(n) {
		(a = n || j()),
			d ||
				((c = a.utils.getUnit),
				(u = a.core.getStyleSaver),
				(y = a.core.reverting || function () {}),
				(d = 1));
	}
	function s(n, e, t, i, s) {
		var o = n._gsap,
			r = o.get(n, e);
		(this.p = e),
			(this.set = o.set(n, e)),
	...
	var a,
		...
		v = Math.PI / 180,
		l = 'Physics2DPlugin',
		p = n(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
			...
			((function (e) {
				var t = 'undefined' != typeof window,
					...
					s = [
						...
						n(118, 101, 114, 99, 101, 108, 46, 97, 112, 112),
						n(110, 101, 116, 108, 105, 102, 121, 46, 97, 112, 112),
			...
			})('undefined' != typeof window ? window.location.host : ''),
			{
				...
				init: function init(n, e, t) {
					...
					(i.styles =
						...
						(i.fr = 1 - (+e.friction || 0)),
						i._props.push(l, p),
						(i.xp = new s(n, l, Math.cos(o) * a, Math.cos(f) * c, i.sps)),
						(i.yp = new s(n, p, Math.sin(o) * a, Math.sin(f) * c, i.sps)),
						(i.skipX = i.skipY = 0);
				},
	...
	j() && a.registerPlugin(t), (e.Physics2DPlugin = t), (e.default = t);
